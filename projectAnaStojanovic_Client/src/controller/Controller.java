...
public class Controller {
    ...
    public List<Korisnik> vratiListuKorisnika() {
        ...
        return (List<Korisnik>) Communication.getInstance().getResponce().getResponse();
    }

    public Integer ubaciKorisnika(Korisnik k) {
        ClientRequest clientRequest = new ClientRequest(Operations.ubaciKorisnika, k);
        Communication.getInstance().sendRequest(clientRequest);
        return (Integer) Communication.getInstance().getResponce().getResponse();
    }
    ...
    public List<Predstava> vratiListuPredstava() {
        ...
        Communication.getInstance().sendRequest(clientRequest);
        return (List<Predstava>) Communication.getInstance().getResponce().getResponse();
    }
...
//    }
    ...
    public List<Reziser> vratiListuRezisera() {
        ...
        Communication.getInstance().sendRequest(clientRequest);
        return (List<Reziser>) Communication.getInstance().getResponce().getResponse();
    }

    public List<Glumac> vratiListuGlumaca() {
        ClientRequest clientRequest = new ClientRequest(Operations.vratiListuGlumaca, null);
        Communication.getInstance().sendRequest(clientRequest);
        return (List<Glumac>) Communication.getInstance().getResponce().getResponse();
    }
    ...
    public List<Repertoar> vratiListuRepertoara() {
        ...
        Communication.getInstance().sendRequest(clientRequest);
        return (List<Repertoar>) Communication.getInstance().getResponce().getResponse();
    }
    ...
    public long ubaciRepertoar(Repertoar p) {
        ...
        Communication.getInstance().sendRequest(clientRequest);
        return (long) Communication.getInstance().getResponce().getResponse();
    }
   ...
   public void sendMail(String mail, String randomPass) {
    ...
    public List<Glumi> vratiListuGlumi(Predstava p) {
        ...
        Communication.getInstance().sendRequest(clientRequest);
        return (List<Glumi>) Communication.getInstance().getResponce().getResponse();
    }
    ...
    public List<Scenograf> vratiListuScenografa() {
        ...
        Communication.getInstance().sendRequest(clientRequest);
        return (List<Scenograf>) Communication.getInstance().getResponce().getResponse();
    }
    ...
    public List<Kostimograf> vratiListuKostimografa() {
        ...
        Communication.getInstance().sendRequest(clientRequest);
        return (List<Kostimograf>) Communication.getInstance().getResponce().getResponse();
    }
    ...
    public List<Koreograf> vratiListuKoreografa() {
        ...
        Communication.getInstance().sendRequest(clientRequest);
        return (List<Koreograf>) Communication.getInstance().getResponce().getResponse();
    }
