...
public class MainForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jMenu4.setText("Glumci");

        jMenuItem2.setText("Prikazi sve");
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        ShowActors sa=new ShowActors(this, true, korisnik, currentLocale);
        sa.setVisible(true);
    ...
    private void updateTexts() {
        ...
        jMenu4.setText(messages.getString("jMenu4.text"));
        jMenuItem2.setText(messages.getString("prikaziSve.text"));
