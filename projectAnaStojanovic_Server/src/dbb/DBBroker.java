...
public class DBBroker {
    ...
    public ArrayList<AbstractDomainObject> selectWithAttribute(AbstractDomainObject odo, Object o) throws SQLException {
        String upit;
       upit = "SELECT "+odo.searchAttribute() +" FROM " + odo.tableName() + " " + odo.alijas()
                + " " + odo.requirementForSelect(o); 
