 ...
 * @author Ana
 */
public class Koreograf extends AbstractDomainObject{
       private long jmbg;
    private String ime;
    ...
    public Koreograf(long jmbg, String ime, String prezime) {
        this.jmbg = jmbg;
        this.ime = ime;
    ...
    public ArrayList<AbstractDomainObject> getList(ResultSet rs, Object o) throws SQLException {
        ...
        while (rs.next()) {
            ...
            String ime=rs.getString("imeKor");
              String prezime=rs.getString("prezimeKor");
